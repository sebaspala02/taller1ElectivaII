...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2020 a las 05:43:51
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarMedi` (IN `vidmedicamento` INT)  BEGIN
	select m.idmedicamento,m.nombre, m.descrip as descripcion, m.fecha_venc as vencimiento, m.cant as cantidad, m.fecha_creado as registro, m.precio as precio, u.usuario as usuario, l.nombre as laboratorio, l.idlaboratorio,p.nombre as proveedor from medicamento m join laboratorio l on m.laboratorio_idlaboratorio = l.idlaboratorio join usuario u on m.usuario_idusuario = u.idusuario join proveedor p on m.proveedor_id = p.id order by idmedicamento;
END$$
...
(3, 'khjkhjk-122112', 'jkhjkhkj', 'jkljkljlk');
...
INSERT INTO `medicamento` (`idmedicamento`, `nombre`, `descrip`, `fecha_venc`, `cant`, `fecha_creado`, `precio`, `usuario_idusuario`, `laboratorio_idlaboratorio`, `proveedor_id`) VALUES
(1, 'ACETAMINOFEN', 'no sea', '2032-02-02', '0', '2020-02-02', 1, 13, 1, 1),
(2, 'IBUPRO', 'ajkn', '2019-12-31', '654', '2021-12-02', 1500, 13, 1, 3),
(3, 'ADW', 'jn', '2017-12-31', '0', '2017-12-26', 100, 13, 1, 2),
(6, 'prueba', 'prueba', '2017-12-31', '110', '2017-12-01', 1, 13, 1, 1);
...
(15, 14355, 'cliente1', 'gomez', 'correo@ocr.com', 3, 'ufho3', 5343, 1100);
...
(2, '2020-05-28 15:19:29', 55, 15, 14),
(3, '2020-05-28 15:38:34', 1, 15, 14),
(4, '2020-05-28 15:38:44', 1, 15, 14),
(5, '2020-05-28 15:47:25', 3, 15, 14),
(6, '2020-05-28 15:47:33', 2, 15, 14),
(7, '2020-05-28 15:47:39', 56, 15, 14),
(8, '2020-05-28 16:40:08', 3, 15, 14),
(9, '2020-05-28 16:40:17', 110, 15, 14),
(10, '2020-05-28 16:56:38', 12000, 15, 14),
(11, '2020-05-28 17:00:34', 13500, 15, 14),
(12, '2020-05-28 17:01:24', 15000, 15, 14),
(13, '2020-05-28 17:03:14', 13500, 15, 14),
(14, '2020-05-28 17:03:32', 21000, 15, 14),
(15, '2020-05-28 17:15:17', 12000, 15, 14),
(16, '2020-05-28 17:15:27', 12000, 15, 14),
(17, '2020-05-28 17:20:53', 19500, 15, 14),
(18, '2020-05-28 17:23:03', 10500, 15, 14),
(19, '2020-05-28 17:24:00', 13500, 15, 14),
(20, '2020-05-28 17:25:15', 12000, 15, 14),
(21, '2020-05-28 17:40:43', 12000, 15, 14),
(22, '2020-05-28 17:41:46', 10500, 15, 14),
(23, '2020-05-28 17:42:00', 4500, 15, 14),
(24, '2020-05-28 17:42:23', 1500, 15, 14),
(25, '2020-05-28 17:43:34', 1500, 15, 14),
(26, '2020-05-28 17:43:45', 12000, 15, 14),
(27, '2020-05-29 03:12:43', 10500, 15, 14),
(28, '2020-05-29 03:12:57', 12000, 15, 14);
...
ALTER TABLE `medicamento`
  ...
  ADD KEY `medicamento_ibfk_3` (`proveedor_id`);
...
--
ALTER TABLE `estante`
  MODIFY `idestante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
